            ...
            <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
              ...
              <div class="card text-white bg-aeroblack" style="width: 100%;margin-bottom:10px;">
                ...
                <div class="card-body">
                  ...
                  <img class="user__img" src="{{ asset('public/images/ney2.jpg') }}" alt="" style="width: 3rem; height: 3rem; border-radius: 50%; margin-right: .8rem; float: left;">

                  <div style="float: left; margin-top: .2rem;">

                    <div style="font-weight: 600; font-size: .9rem;">Neyelson Alves</div>
              ...
              <a class="nav-link text-white bg-aeroblack <?php if (Route::current()->uri() === 'dashboard') { echo 'active'; } ?>" href="dashboard"><i class="fa fa-home"></i> Início</a>
